...
#define	CPPI_FFTC_BUF_LEN		8192 * 14
...
extern void fftc_system_deinit();
extern signed int Setup_Tx_FDQ (void);
extern signed int Setup_Rx_FDQ ();
...
extern unsigned int fftc_recv_pkt(unsigned int queue_num,unsigned char start_symbol,unsigned char end_symbol);
extern unsigned int fftc_recv_pkt_symbol0(unsigned int queue_num,unsigned char OFDMA_start,unsigned char OFDMA_end);
