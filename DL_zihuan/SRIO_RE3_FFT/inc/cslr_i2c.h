...
\**************************************************************************/
typedef struct  {
    volatile unsigned int ICOAR;
    volatile unsigned int ICIMR;
    volatile unsigned int ICSTR;
    volatile unsigned int ICCLKL;
    volatile unsigned int ICCLKH;
    volatile unsigned int ICCNT;
    volatile unsigned int ICDRR;
    volatile unsigned int ICSAR;
    volatile unsigned int ICDXR;
    volatile unsigned int ICMDR;
    volatile unsigned int ICIVR;
    volatile unsigned int ICEMDR;
    volatile unsigned int ICPSC;
    volatile unsigned int ICPID1;
    volatile unsigned int ICPID2;
} CSL_I2cRegs;
