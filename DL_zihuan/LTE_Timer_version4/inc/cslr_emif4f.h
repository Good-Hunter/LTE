...
\**************************************************************************/
typedef struct  {
    volatile unsigned int EMIF_MOD_ID_REV;
    volatile unsigned int STATUS;
    volatile unsigned int SDRAM_CONFIG;
    volatile unsigned int SDRAM_CONFIG_2;
    volatile unsigned int SDRAM_REF_CTRL;
    volatile unsigned int SDRAM_REF_CTRL_SHDW;
    volatile unsigned int SDRAM_TIM_1;
    volatile unsigned int SDRAM_TIM_1_SHDW;
    volatile unsigned int SDRAM_TIM_2;
    volatile unsigned int SDRAM_TIM_2_SHDW;
    volatile unsigned int SDRAM_TIM_3;
    volatile unsigned int SDRAM_TIM_3_SHDW;
    volatile unsigned int LPDDR2_NVM_TIM;
    volatile unsigned int LPDDR2_NVM_TIM_SHDW;
    volatile unsigned int PWR_MGMT_CTRL;
    volatile unsigned int PWR_MGMT_CTRL_SHDW;
    volatile unsigned int LPDDR2_MODE_REG_DATA;
    volatile unsigned char RSVD0[12];
    volatile unsigned int LPDDR2_MODE_REG_CFG;
    volatile unsigned int VBUSM_CONFIG;
    volatile unsigned int VBUSM_CFG_VAL_1;
    volatile unsigned int VBUSM_CFG_VAL_2;
    volatile unsigned int IODFT_TLGC;
    volatile unsigned int IODFT_CTRL_MISR_RSLT;
    volatile unsigned int IODFT_ADDR_MISR_RSLT;
    volatile unsigned int IODFT_DATA_MISR_RSLT_1;
    volatile unsigned int IODFT_DATA_MISR_RSLT_2;
    volatile unsigned int IODFT_DATA_MISR_RSLT_3;
    volatile unsigned int IODFT_DATA_MISR_RSLT_4;
    volatile unsigned int IODFT_DATA_MISR_RSLT_5;
    ...
    volatile unsigned int PERF_CNT_TIM;
    volatile unsigned char RSVD1[4];
    volatile unsigned int READ_IDLE_CTRL;
    volatile unsigned int READ_IDLE_CTRL_SHDW;
    volatile unsigned char RSVD2[4];
    volatile unsigned int IRQSTATUS_RAW_SYS;
    volatile unsigned char RSVD3[4];
    volatile unsigned int IRQSTATUS_SYS;
    volatile unsigned char RSVD4[4];
    volatile unsigned int IRQENABLE_SET_SYS;
    volatile unsigned char RSVD5[4];
    volatile unsigned int IRQENABLE_CLR_SYS;
    volatile unsigned char RSVD6[8];
    volatile unsigned int ZQ_CONFIG;
    volatile unsigned int TEMP_ALERT_CONFIG;
    volatile unsigned int VBUSM_ERR_LOG;
    volatile unsigned int RDWR_LVL_RMP_WIN;
    volatile unsigned int RDWR_LVL_RMP_CTRL;
    volatile unsigned int RDWR_LVL_CTRL;
    volatile unsigned char RSVD7[4];
    volatile unsigned int DDR_PHY_CTRL_1;
    volatile unsigned int DDR_PHY_CTRL_1_SHDW;
    volatile unsigned int DDR_PHY_CTRL_2;
    volatile unsigned char RSVD8[16];
    volatile unsigned int PRI_COS_MAP;
    volatile unsigned int MSTID_COS_1_MAP;
    volatile unsigned int MSTID_COS_2_MAP;
    volatile unsigned char RSVD9[4];
    volatile unsigned int ECC_CTRL;
    volatile unsigned int ECC_ADDR_RNG_1;
    volatile unsigned int ECC_ADDR_RNG_2;
    volatile unsigned char RSVD10[4];
    volatile unsigned int RD_WR_EXEC_THRSH;
} CSL_Emif4fRegs;
