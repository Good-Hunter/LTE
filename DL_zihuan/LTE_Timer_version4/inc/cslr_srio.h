...
\**************************************************************************/
typedef struct  {
    volatile unsigned int RIO_BLK_EN;
    volatile unsigned int RIO_BLK_EN_STAT;
...
\**************************************************************************/
typedef struct  {
    volatile unsigned int RIO_PF_16B_CNTL;
    volatile unsigned int RIO_PF_8B_CNTL;
} CSL_SrioPf_cntlRegs;
...
\**************************************************************************/
typedef struct  {
    volatile unsigned int RIO_DOORBELL_ICSR;
    volatile unsigned char RSVD0[4];
    volatile unsigned int RIO_DOORBELL_ICCR;
...
\**************************************************************************/
typedef struct  {
    volatile unsigned int RIO_LSU_ICSR;
    volatile unsigned char RSVD0[4];
    volatile unsigned int RIO_LSU_ICCR;
...
\**************************************************************************/
typedef struct  {
    volatile unsigned int RIO_DOORBELL_ICRR1;
    volatile unsigned int RIO_DOORBELL_ICRR2;
    volatile unsigned char RSVD9[4];
...
\**************************************************************************/
typedef struct  {
    volatile unsigned int RIO_RXU_MAP_L;
    volatile unsigned int RIO_RXU_MAP_H;
    volatile unsigned int RIO_RXU_MAP_QID;
} CSL_SrioRxu_mapRegs;
...
\**************************************************************************/
typedef struct  {
    volatile unsigned int RIO_RXU_TYPE9_MAP0;
    volatile unsigned int RIO_RXU_TYPE9_MAP1;
    volatile unsigned int RIO_RXU_TYPE9_MAP2;
...
\**************************************************************************/
typedef struct  {
    volatile unsigned int RIO_AMU_WINDOW_REG0;
    volatile unsigned int RIO_AMU_WINDOW_REG1;
    volatile unsigned int RIO_AMU_WINDOW_REG2;
...
\**************************************************************************/
typedef struct  {
    volatile unsigned int RIO_LSU_REG0;
    volatile unsigned int RIO_LSU_REG1;
    volatile unsigned int RIO_LSU_REG2;
    volatile unsigned int RIO_LSU_REG3;
    volatile unsigned int RIO_LSU_REG4;
    volatile unsigned int RIO_LSU_REG5;
    volatile unsigned int RIO_LSU_REG6;
} CSL_SrioLsu_cmdRegs;
...
typedef struct  {
    ...
    volatile unsigned char RSVD19[24];
...
\**************************************************************************/
typedef struct  {
    volatile unsigned int RIO_SP_LM_REQ;
    volatile unsigned int RIO_SP_LM_RESP;
    volatile unsigned int RIO_SP_ACKID_STAT;
    volatile unsigned char RSVD0[8];
    volatile unsigned int RIO_SP_CTL2;
    volatile unsigned int RIO_SP_ERR_STAT;
    volatile unsigned int RIO_SP_CTL;
} CSL_SrioRio_spRegs;
...
\**************************************************************************/
typedef struct  {
    volatile unsigned int RIO_SP_ERR_DET;
    volatile unsigned int RIO_SP_RATE_EN;
    volatile unsigned int RIO_SP_ERR_ATTR_CAPT;
    volatile unsigned int RIO_SP_ERR_CAPT_0;
    volatile unsigned int RIO_SP_ERR_CAPT_1;
    volatile unsigned int RIO_SP_ERR_CAPT_2;
    volatile unsigned int RIO_SP_ERR_CAPT_3;
    volatile unsigned char RSVD0[12];
    volatile unsigned int RIO_SP_ERR_RATE;
    volatile unsigned int RIO_SP_ERR_THRESH;
    volatile unsigned char RSVD36[16];
...
\**************************************************************************/
typedef struct  {
    volatile unsigned int RIO_LANE_STAT0;
    volatile unsigned int RIO_LANE_STAT1;
    volatile unsigned char RSVD39[24];
...
\**************************************************************************/
typedef struct  {
    volatile unsigned int RIO_PLM_SP_IMP_SPEC_CTL;
    volatile unsigned int RIO_PLM_SP_PWDN_CTL;
    volatile unsigned char RSVD0[8];
    volatile unsigned int RIO_PLM_SP_STATUS;
    volatile unsigned int RIO_PLM_SP_INT_ENABLE;
    volatile unsigned int RIO_PLM_SP_PW_ENABLE;
    volatile unsigned int RIO_PLM_SP_EVENT_GEN;
    volatile unsigned int RIO_PLM_SP_ALL_INT_EN;
    volatile unsigned int RIO_PLM_SP_ALL_PW_EN;
    volatile unsigned char RSVD1[8];
    volatile unsigned int RIO_PLM_SP_PATH_CTL;
    volatile unsigned int RIO_PLM_SP_DISCOVERY_TIMER;
    volatile unsigned int RIO_PLM_SP_SILENCE_TIMER;
    volatile unsigned int RIO_PLM_SP_VMIN_EXP;
    volatile unsigned int RIO_PLM_SP_POL_CTL;
    volatile unsigned char RSVD2[4];
    volatile unsigned int RIO_PLM_SP_DENIAL_CTL;
    volatile unsigned char RSVD3[4];
    volatile unsigned int RIO_PLM_SP_RCVD_MECS;
    volatile unsigned char RSVD4[4];
    volatile unsigned int RIO_PLM_SP_MECS_FWD;
    volatile unsigned char RSVD5[4];
    volatile unsigned int RIO_PLM_SP_LONG_CS_TX1;
    volatile unsigned int RIO_PLM_SP_LONG_CS_TX2;
    volatile unsigned char RSVD42[24];
} CSL_SrioRio_plmRegs;

#ifndef CSL_MODIFICATION

typedef struct  {
    volatile unsigned int RIO_TLM_SP_BRR_CTL;
    volatile unsigned int RIO_TLM_SP_BRR_PATTERN_MATCH;
    volatile unsigned char RSVD1[8];
...
\**************************************************************************/
typedef struct  {
    volatile unsigned int RIO_TLM_SP_CONTROL;
    volatile unsigned char RSVD0[12];
    volatile unsigned int RIO_TLM_SP_STATUS;
    volatile unsigned int RIO_TLM_SP_INT_ENABLE;
    volatile unsigned int RIO_TLM_SP_PW_ENABLE;
    volatile unsigned int RIO_TLM_SP_EVENT_GEN;
#ifdef CSL_MODIFICATION    
    volatile unsigned int RIO_TLM_SP_BRR_0_CTL;
    volatile unsigned int RIO_TLM_SP_BRR_0_PATTERN_MATCH;
    volatile unsigned char RSVD1[8];
    volatile unsigned int RIO_TLM_SP_BRR_1_CTL;
    volatile unsigned int RIO_TLM_SP_BRR_1_PATTERN_MATCH;
    volatile unsigned char RSVD2[8];
    volatile unsigned int RIO_TLM_SP_BRR_2_CTL;
    volatile unsigned int RIO_TLM_SP_BRR_2_PATTERN_MATCH;
    volatile unsigned char RSVD3[8];
    volatile unsigned int RIO_TLM_SP_BRR_3_CTL;
    volatile unsigned int RIO_TLM_SP_BRR_3_PATTERN_MATCH;
    volatile unsigned char RSVD45[40];
#else
    CSL_SrioRio_BRRConfig   brr[4];
    volatile unsigned char          RSVD45[32];
#endif
} CSL_SrioRio_tlmRegs;
...
\**************************************************************************/
typedef struct  {
    volatile unsigned int RIO_PBM_SP_CONTROL;
    volatile unsigned char RSVD0[12];
    volatile unsigned int RIO_PBM_SP_STATUS;
    volatile unsigned int RIO_PBM_SP_INT_ENABLE;
    volatile unsigned int RIO_PBM_SP_PW_ENABLE;
    volatile unsigned int RIO_PBM_SP_EVENT_GEN;
    volatile unsigned int RIO_PBM_SP_IG_RESOURCES;
    volatile unsigned int RIO_PBM_SP_EG_RESOURCES;
    volatile unsigned char RSVD1[8];
    volatile unsigned int RIO_PBM_SP_IG_WATERMARK0;
    volatile unsigned int RIO_PBM_SP_IG_WATERMARK1;
    volatile unsigned int RIO_PBM_SP_IG_WATERMARK2;
    volatile unsigned int RIO_PBM_SP_IG_WATERMARK3;
    volatile unsigned char RSVD48[64];
} CSL_SrioRio_pbmRegs;
...
\**************************************************************************/
typedef struct  {
    volatile unsigned int RIO_PID;
    volatile unsigned int RIO_PCR;
    volatile unsigned char RSVD0[12];
    volatile unsigned int RIO_PER_SET_CNTL;
    volatile unsigned int RIO_PER_SET_CNTL1;
    volatile unsigned char RSVD1[8];
    volatile unsigned int RIO_GBL_EN;
    volatile unsigned int RIO_GBL_EN_STAT;
    CSL_SrioBlock_enable_statusRegs BLOCK_ENABLE_STATUS[10];
    volatile unsigned char RSVD2[68];
    volatile unsigned int RIO_MULTIID_REG[8];
    CSL_SrioPf_cntlRegs PF_CNTL[8];
    volatile unsigned char RSVD4[96];
    CSL_SrioDoorbell_icsr_iccrRegs DOORBELL_ICSR_ICCR[4];
    CSL_SrioLsu_icsr_iccrRegs LSU_ICSR_ICCR[2];
    volatile unsigned int RIO_ERR_RST_EVNT_ICSR;
    volatile unsigned char RSVD6[4];
    volatile unsigned int RIO_ERR_RST_EVNT_ICCR;
    volatile unsigned char RSVD7[4];
    volatile unsigned int RIO_AMU_ICSR;
    volatile unsigned char RSVD8[4];
    volatile unsigned int RIO_AMU_ICCR;
    volatile unsigned char RSVD10[4];
    CSL_SrioDoorbell_icrrRegs DOORBELL_ICRR[4];
    volatile unsigned int RIO_LSU0_MODULE_ICRR[4];
    volatile unsigned int RIO_LSU1_MODULE_ICRR;
    volatile unsigned char RSVD11[12];
    volatile unsigned int RIO_ERR_RST_EVNT_ICRR;
    volatile unsigned int RIO_ERR_RST_EVNT_ICRR2;
    volatile unsigned int RIO_ERR_RST_EVNT_ICRR3;
    volatile unsigned int RIO_AMU_ICRR1;
    volatile unsigned int RIO_AMU_ICRR2;
    volatile unsigned int RIO_INTERRUPT_CTL;
    volatile unsigned char RSVD12[8];
    volatile unsigned int RIO_INTDST_DECODE[24];
    volatile unsigned int RIO_INTDST_RATE_CNT[16];
    volatile unsigned int RIO_INTDST_RATE_DIS;
    volatile unsigned char RSVD13[236];
    CSL_SrioRxu_mapRegs RXU_MAP[64];
    CSL_SrioRxu_type9_mapRegs RXU_TYPE9_MAP[64];
    volatile unsigned int RIO_AMU_SRCID_MAP[4];
    volatile unsigned char RSVD14[4];
    CSL_SrioAmu_windowRegs AMU_WINDOW[16];
    volatile unsigned int RIO_AMU_PRIORITY_MAP;
    volatile unsigned int RIO_AMU_CAPT0_MAP;
    volatile unsigned int RIO_AMU_CAPT1_MAP;
    volatile unsigned int RIO_AMU_WINDOW_PANE[128];
    volatile unsigned int RIO_AMU_FLOW_MASKS0;
    volatile unsigned char RSVD15[28];
    CSL_SrioLsu_cmdRegs LSU_CMD[8];
    volatile unsigned int RIO_LSU_SETUP_REG0;
    volatile unsigned int RIO_LSU_SETUP_REG1;
    volatile unsigned int LSU_STAT_REG[6];
    volatile unsigned int RIO_LSU_FLOW_MASKS[4];
    volatile unsigned char RSVD16[60];
    volatile unsigned int RIO_SUPERVISOR_ID;
    volatile unsigned int RIO_FLOW_CNTL[16];
    volatile unsigned char RSVD17[32];
    volatile unsigned int RIO_TX_CPPI_FLOW_MASKS[8];
    volatile unsigned int RIO_TX_QUEUE_SCH_INFO[4];
    volatile unsigned int RIO_GARBAGE_COLL_QID0;
    volatile unsigned int RIO_GARBAGE_COLL_QID1;
    volatile unsigned int RIO_GARBAGE_COLL_QID2;
    volatile unsigned char RSVD18[276];
    ...
    volatile unsigned char RSVD20[992];
    CSL_SrioTx_channel_global_configRegs TX_CHANNEL_GLOBAL_CONFIG[16];
    volatile unsigned char RSVD22[512];
    CSL_SrioRx_channel_global_configRegs RX_CHANNEL_GLOBAL_CONFIG[16];
    volatile unsigned char RSVD23[512];
    volatile unsigned int TX_CHANNEL_SCHEDULER_CONFIG_REG[16];
    volatile unsigned char RSVD24[960];
    CSL_SrioRx_flow_configRegs RX_FLOW_CONFIG[20];
    volatile unsigned char RSVD25[36224];
    volatile unsigned int RIO_DEV_ID;
    volatile unsigned int RIO_DEV_INFO;
    volatile unsigned int RIO_ASBLY_ID;
    volatile unsigned int RIO_ASBLY_INFO;
    volatile unsigned int RIO_PE_FEAT;
    volatile unsigned int RIO_SW_PORT;
    volatile unsigned int RIO_SRC_OP;
    volatile unsigned int RIO_DEST_OP;
    volatile unsigned char RSVD26[28];
    volatile unsigned int RIO_DS_INFO;
    volatile unsigned char RSVD27[8];
    volatile unsigned int RIO_DS_LL_CTL;
    volatile unsigned int RIO_PE_LL_CTL;
    volatile unsigned char RSVD28[8];
    volatile unsigned int RIO_LCL_CFG_HBAR;
    volatile unsigned int RIO_LCL_CFG_BAR;
    volatile unsigned int RIO_BASE_ID;
    volatile unsigned char RSVD29[4];
    volatile unsigned int RIO_HOST_BASE_ID_LOCK;
    volatile unsigned int RIO_COMP_TAG;
    volatile unsigned char RSVD30[144];
    volatile unsigned int RIO_SP_MB_HEAD;
    volatile unsigned char RSVD31[28];
    volatile unsigned int RIO_SP_LT_CTL;
    volatile unsigned int RIO_SP_RT_CTL;
    volatile unsigned char RSVD32[20];
    volatile unsigned int RIO_SP_GEN_CTL;
    CSL_SrioRio_spRegs RIO_SP[4];
    volatile unsigned char RSVD33[3648];
    volatile unsigned int RIO_ERR_RPT_BH;
    volatile unsigned char RSVD34[4];
    volatile unsigned int RIO_ERR_DET;
    volatile unsigned int RIO_ERR_EN;
    volatile unsigned int RIO_H_ADDR_CAPT;
    volatile unsigned int RIO_ADDR_CAPT;
    volatile unsigned int RIO_ID_CAPT;
    volatile unsigned int RIO_CTRL_CAPT;
    volatile unsigned char RSVD35[8];
    volatile unsigned int RIO_PW_TGT_ID;
    volatile unsigned char RSVD37[20];
    CSL_SrioRio_sp_errRegs RIO_SP_ERR[4];
    volatile unsigned char RSVD38[7872];
    volatile unsigned int RIO_PER_LANE_BH;
    volatile unsigned char RSVD40[12];
    CSL_SrioRio_laneRegs RIO_LANE[4];
    volatile unsigned char RSVD41[53104];
    volatile unsigned int RIO_PLM_BH;
    volatile unsigned char RSVD43[124];
    CSL_SrioRio_plmRegs RIO_PLM[4];
    volatile unsigned char RSVD44[128];
    volatile unsigned int RIO_TLM_BH;
    volatile unsigned char RSVD46[124];
    CSL_SrioRio_tlmRegs RIO_TLM[4];
    volatile unsigned char RSVD47[128];
    volatile unsigned int RIO_PBM_BH;
    volatile unsigned char RSVD49[124];
    CSL_SrioRio_pbmRegs RIO_PBM[4];
    volatile unsigned char RSVD50[128];
    volatile unsigned int RIO_EM_BH;
    volatile unsigned char RSVD51[12];
    volatile unsigned int RIO_EM_INT_STAT;
    volatile unsigned int RIO_EM_INT_ENABLE;
    volatile unsigned int RIO_EM_INT_PORT_STAT;
    volatile unsigned char RSVD52[4];
    volatile unsigned int RIO_EM_PW_STAT;
    volatile unsigned int RIO_EM_PW_EN;
    volatile unsigned int RIO_EM_PW_PORT_STAT;
    volatile unsigned char RSVD53[4];
    volatile unsigned int RIO_EM_DEV_INT_EN;
    volatile unsigned int RIO_EM_DEV_PW_EN;
    volatile unsigned char RSVD54[4];
    volatile unsigned int RIO_EM_MECS_STAT;
    volatile unsigned int RIO_EM_MECS_INT_EN;
    volatile unsigned int RIO_EM_MECS_CAP_EN;
    volatile unsigned int RIO_EM_MECS_TRIG_EN;
    volatile unsigned int RIO_EM_MECS_REQ;
    volatile unsigned int RIO_EM_MECS_PORT_STAT;
    volatile unsigned char RSVD55[8];
    volatile unsigned int RIO_EM_MECS_EVENT_GEN;
    volatile unsigned int RIO_EM_RST_PORT_STAT;
    volatile unsigned char RSVD56[4];
    volatile unsigned int RIO_EM_RST_INT_EN;
    volatile unsigned char RSVD57[4];
    volatile unsigned int RIO_EM_RST_PW_EN;
    volatile unsigned char RSVD58[140];
    volatile unsigned int RIO_PW_BH;
    volatile unsigned int RIO_PW_CTL;
    volatile unsigned int RIO_PW_ROUTE;
    volatile unsigned char RSVD59[4];
    volatile unsigned int RIO_PW_RX_STAT;
    volatile unsigned int RIO_PW_RX_EVENT_GEN;
    volatile unsigned char RSVD60[8];
    volatile unsigned int RIO_PW_RX_CAPT[4];
    volatile unsigned char RSVD61[720];
    volatile unsigned int RIO_LLM_BH;
    volatile unsigned char RSVD62[32];
    volatile unsigned int RIO_WHITEBOARD;
    volatile unsigned int RIO_PORT_NUMBER;
    volatile unsigned char RSVD63[4];
    volatile unsigned int RIO_PRESCALAR_SRV_CLK;
    volatile unsigned int RIO_REG_RST_CTL;
    volatile unsigned char RSVD64[16];
    volatile unsigned int RIO_LOCAL_ERR_DET;
    volatile unsigned int RIO_LOCAL_ERR_EN;
    volatile unsigned int RIO_LOCAL_H_ADDR_CAPT;
    volatile unsigned int RIO_LOCAL_ADDR_CAPT;
    volatile unsigned int RIO_LOCAL_ID_CAPT;
    volatile unsigned int RIO_LOCAL_CTRL_CAPT;
    volatile unsigned char RSVD65[160];
    volatile unsigned int RIO_FABRIC_BH;
    volatile unsigned char RSVD66[12];
    volatile unsigned int RIO_FABRIC_CSR;
    volatile unsigned char RSVD67[44];
    volatile unsigned int RIO_SP_FABRIC_STATUS[4];
} CSL_SrioRegs;
