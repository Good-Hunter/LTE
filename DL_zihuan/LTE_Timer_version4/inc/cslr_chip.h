...
#define CSL_CHIP_DIER_NMI_MASK           (0x80000000u)
#define CSL_CHIP_DIER_NMI_SHIFT          (0x0000001Fu)
#define CSL_CHIP_DIER_NMI_RESETVAL       (0x00000000u)

#define CSL_CHIP_DIER_EXCEP_MASK         (0x40000000u)
#define CSL_CHIP_DIER_EXCEP_SHIFT        (0x0000001Eu)
#define CSL_CHIP_DIER_EXCEP_RESETVAL     (0x00000000u)

#define CSL_CHIP_DIER_INT15_MASK         (0x00008000u)
#define CSL_CHIP_DIER_INT15_SHIFT        (0x0000000Fu)
#define CSL_CHIP_DIER_INT15_RESETVAL     (0x00000000u)

#define CSL_CHIP_DIER_INT14_MASK         (0x00004000u)
#define CSL_CHIP_DIER_INT14_SHIFT        (0x0000000Eu)
#define CSL_CHIP_DIER_INT14_RESETVAL     (0x00000000u)

#define CSL_CHIP_DIER_INT13_MASK         (0x00002000u)
#define CSL_CHIP_DIER_INT13_SHIFT        (0x0000000Du)
#define CSL_CHIP_DIER_INT13_RESETVAL     (0x00000000u)

#define CSL_CHIP_DIER_INT12_MASK         (0x00001000u)
#define CSL_CHIP_DIER_INT12_SHIFT        (0x0000000Cu)
#define CSL_CHIP_DIER_INT12_RESETVAL     (0x00000000u)

#define CSL_CHIP_DIER_INT11_MASK         (0x00000800u)
#define CSL_CHIP_DIER_INT11_SHIFT        (0x0000000Bu)
#define CSL_CHIP_DIER_INT11_RESETVAL     (0x00000000u)

#define CSL_CHIP_DIER_INT10_MASK         (0x00000400u)
#define CSL_CHIP_DIER_INT10_SHIFT        (0x0000000Au)
#define CSL_CHIP_DIER_INT10_RESETVAL     (0x00000000u)

#define CSL_CHIP_DIER_INT9_MASK          (0x00000200u)
#define CSL_CHIP_DIER_INT9_SHIFT         (0x00000009u)
#define CSL_CHIP_DIER_INT9_RESETVAL      (0x00000000u)

#define CSL_CHIP_DIER_INT8_MASK          (0x00000100u)
#define CSL_CHIP_DIER_INT8_SHIFT         (0x00000008u)
#define CSL_CHIP_DIER_INT8_RESETVAL      (0x00000000u)

#define CSL_CHIP_DIER_INT7_MASK          (0x00000080u)
#define CSL_CHIP_DIER_INT7_SHIFT         (0x00000007u)
#define CSL_CHIP_DIER_INT7_RESETVAL      (0x00000000u)

#define CSL_CHIP_DIER_INT6_MASK          (0x00000040u)
#define CSL_CHIP_DIER_INT6_SHIFT         (0x00000006u)
#define CSL_CHIP_DIER_INT6_RESETVAL      (0x00000000u)

#define CSL_CHIP_DIER_INT5_MASK          (0x00000020u)
#define CSL_CHIP_DIER_INT5_SHIFT         (0x00000005u)
#define CSL_CHIP_DIER_INT5_RESETVAL      (0x00000000u)

#define CSL_CHIP_DIER_INT4_MASK          (0x00000010u)
#define CSL_CHIP_DIER_INT4_SHIFT         (0x00000004u)
#define CSL_CHIP_DIER_INT4_RESETVAL      (0x00000000u)

#define CSL_CHIP_DIER_MSG_MASK           (0x00000008u)
#define CSL_CHIP_DIER_MSG_SHIFT          (0x00000003u)
#define CSL_CHIP_DIER_MSG_RESETVAL       (0x00000000u)

#define CSL_CHIP_DIER_WSEL_MASK          (0x00000002u)
#define CSL_CHIP_DIER_WSEL_SHIFT         (0x00000001u)
#define CSL_CHIP_DIER_WSEL_RESETVAL      (0x00000000u)

#define CSL_CHIP_DIER_TSCC_MASK          (0x00000001u)
#define CSL_CHIP_DIER_TSCC_SHIFT         (0x00000000u)
#define CSL_CHIP_DIER_TSCC_RESETVAL      (0x00000000u)
