...
typedef struct  {
    ...
    volatile unsigned int DIE_ID_REG0;
    volatile unsigned int DIE_ID_REG1;
    volatile unsigned int DIE_ID_REG2;
    volatile unsigned int DIE_ID_REG3;
    volatile unsigned int DEVICE_ID_REG0;
    volatile unsigned int DEVICE_ID_REG1;
    volatile unsigned int BOOT_REG0;
    volatile unsigned char RSVD1[20];
    volatile unsigned int KICK_REG0;
    volatile unsigned int KICK_REG1;
#ifdef CSL_MODIFICATION    
    volatile unsigned int BOOTADDR_GEM0_REG;
    volatile unsigned int BOOTADDR_GEM1_REG;
    volatile unsigned int BOOTADDR_GEM2_REG;
    volatile unsigned int BOOTADDR_GEM3_REG;
#else
    volatile unsigned int BOOTADDR_GEM_REG[4];
#endif    
    volatile unsigned char RSVD2[144];
    volatile unsigned int INTR_RAW_STATUS_REG;
    volatile unsigned int INTR_ENABLED_STATUS_REG;
    volatile unsigned int INTR_ENABLE_REG;
    volatile unsigned int INTR_ENABLE_CLR_REG;
    volatile unsigned int EOI_REG;
    volatile unsigned int FAULT_ADDRESS_REG;
    volatile unsigned int FAULT_STATUS_REG;
    volatile unsigned int FAULT_CLEAR_REG;
    volatile unsigned char RSVD3[16];
    volatile unsigned int EMAC_ID1;
    volatile unsigned int EMAC_ID2;
    volatile unsigned char RSVD4[24];
    volatile unsigned int LRSTNMISTAT_CLR;
    volatile unsigned int RESET_STAT_CLR;
    volatile unsigned char RSVD5[4];
    volatile unsigned int BOOT_COMPLETE;
    volatile unsigned int BOOT_PROGRESS;
    volatile unsigned int RESET_STAT;
    volatile unsigned int LRSTNMISTAT;
    volatile unsigned int DEVCFG;
    volatile unsigned int PWR_STAT;
    volatile unsigned int STS_SRIO;
    volatile unsigned int STS_SGMII;
    volatile unsigned int STS_PCIE;
    volatile unsigned int STS_VUSR;
    volatile unsigned int STS_AIF2_B8;
    volatile unsigned int STS_AIF2_B4;
    volatile unsigned char RSVD6[20];
    volatile unsigned int CLASS0_EFUSE_REG;
    volatile unsigned char RSVD7[12];
    volatile unsigned int EFUSE_REG0;
    volatile unsigned int EFUSE_REG1;
    volatile unsigned int EFUSE_REG2;
    volatile unsigned int EFUSE_REG3;
    volatile unsigned int EFUSE_REG4;
    volatile unsigned int EFUSE_REG5;
    volatile unsigned int EFUSE_REG6;
    volatile unsigned int EFUSE_REG7;
    volatile unsigned int EFUSE_REG8;
    volatile unsigned int EFUSE_REG9;
    volatile unsigned int EFUSE_REG10;
    volatile unsigned int EFUSE_REG11;
    volatile unsigned int EFUSE_REG12;
    volatile unsigned int EFUSE_REG13;
    volatile unsigned int EFUSE_REG14;
    volatile unsigned int EFUSE_REG15;
    volatile unsigned char RSVD8[48];
#ifdef CSL_MODIFICATION    
    volatile unsigned int NMIGR_0;
    volatile unsigned int NMIGR_1;
    volatile unsigned int NMIGR_2;
    volatile unsigned int NMIGR_3;
#else
    volatile unsigned int NMIGR[4];
#endif    
    volatile unsigned char RSVD9[48];
#ifdef CSL_MODIFICATION    
    volatile unsigned int IPCGR0;
    volatile unsigned int IPCGR1;
    volatile unsigned int IPCGR2;
    volatile unsigned int IPCGR3;
#else
    volatile unsigned int IPCGR[4];
#endif    
    volatile unsigned char RSVD10[44];
    volatile unsigned int IPCGRH;
#ifdef CSL_MODIFICATION    
    volatile unsigned int IPCAR0;
    volatile unsigned int IPCAR1;
    volatile unsigned int IPCAR2;
    volatile unsigned int IPCAR3;
#else
    volatile unsigned int IPCAR[4];
#endif    
    volatile unsigned char RSVD11[44];
    volatile unsigned int IPCARH;
    volatile unsigned char RSVD12[64];
    volatile unsigned int TINPSEL;
    volatile unsigned int TOUTSEL;
#ifdef CSL_MODIFICATION    
    volatile unsigned int RSTMUX0;
    volatile unsigned int RSTMUX1;
    volatile unsigned int RSTMUX2;
    volatile unsigned int RSTMUX3;
#else
    volatile unsigned int RSTMUX[4];
#endif
    volatile unsigned char RSVD13[16];
    volatile unsigned int CORE_PLL_CTL0;
    volatile unsigned int CORE_PLL_CTL1;
    volatile unsigned int DDR3_PLL_CTL0;
    volatile unsigned int DDR3_PLL_CTL1;
    volatile unsigned int PA_PLL_CTL0;
    volatile unsigned int PA_PLL_CTL1;
    volatile unsigned int SGMII_CFGPLL;
    volatile unsigned int SGMII_CFGRX0;
    volatile unsigned int SGMII_CFGTX0;
    volatile unsigned int SGMII_CFGRX1;
    volatile unsigned int SGMII_CFGTX1;
    volatile unsigned int SGMII_RSVD;
    volatile unsigned int PCIE_CFGPLL;
    volatile unsigned int PCIE_SERDES_RSVD;
    volatile unsigned int SRIO_SERDES_CFGPLL;
    volatile unsigned int SRIO_SERDES_CFGRX0;
    volatile unsigned int SRIO_SERDES_CFGTX0;
    volatile unsigned int SRIO_SERDES_CFGRX1;
    volatile unsigned int SRIO_SERDES_CFGTX1;
    volatile unsigned int SRIO_SERDES_CFGRX2;
    volatile unsigned int SRIO_SERDES_CFGTX2;
    volatile unsigned int SRIO_SERDES_CFGRX3;
    volatile unsigned int SRIO_SERDES_CFGTX3;
    volatile unsigned int SRIO_SERDES_RSVD;
    volatile unsigned int LED_GEM_PASSDONE;
    volatile unsigned int LED_PLLLOCK;
    volatile unsigned int LED_CHIP_PASSDONE;
    volatile unsigned int TDIODE;
    volatile unsigned int MARGIN;
    volatile unsigned int SECURE_CONTROL;
    volatile unsigned char RSVD14[4];
    volatile unsigned int EFUSE_SECROM_CHKSUM0;
    volatile unsigned int EFUSE_SECROM_CHKSUM1;
    volatile unsigned int OBSCLK_CTL;
    volatile unsigned int AIF_SERDES_RSVD;
    volatile unsigned int VUSR_CFGPLL;
    volatile unsigned int VUSR_CFGRX0;
    volatile unsigned int VUSR_CFGTX0;
    volatile unsigned int VUSR_CFGRX1;
    volatile unsigned int VUSR_CFGTX1;
    volatile unsigned int VUSR_CFGRX2;
    volatile unsigned int VUSR_CFGTX2;
    volatile unsigned int VUSR_CFGRX3;
    volatile unsigned int VUSR_CFGTX3;
    volatile unsigned int VUSR_SERDES_RSVD;
    volatile unsigned int LED_GPIO_CLR;
    volatile unsigned int LED_GPIO;
    volatile unsigned char RSVD15[12];
    volatile unsigned int EFUSE_RSVD0;
    volatile unsigned int EFUSE_RSVD1;
    volatile unsigned int EFUSE_RSVD2;
    volatile unsigned int EFUSE_RSVD3;
    volatile unsigned int CHIP_MISC;
#ifdef CSL_MODIFICATION    
    volatile unsigned int DDR3_CONFIG_REG_0;
    volatile unsigned int DDR3_CONFIG_REG_1;
    volatile unsigned int DDR3_CONFIG_REG_2;
    volatile unsigned int DDR3_CONFIG_REG_3;
    volatile unsigned int DDR3_CONFIG_REG_4;
    volatile unsigned int DDR3_CONFIG_REG_5;
    volatile unsigned int DDR3_CONFIG_REG_6;
    volatile unsigned int DDR3_CONFIG_REG_7;
    volatile unsigned int DDR3_CONFIG_REG_8;
    volatile unsigned int DDR3_CONFIG_REG_9;
    volatile unsigned int DDR3_CONFIG_REG_10;
    volatile unsigned int DDR3_CONFIG_REG_11;
    volatile unsigned int DDR3_CONFIG_REG_12;
    volatile unsigned int DDR3_CONFIG_REG_13;
    volatile unsigned int DDR3_CONFIG_REG_14;
    volatile unsigned int DDR3_CONFIG_REG_15;
    volatile unsigned int DDR3_CONFIG_REG_16;
    volatile unsigned int DDR3_CONFIG_REG_17;
    volatile unsigned int DDR3_CONFIG_REG_18;
    volatile unsigned int DDR3_CONFIG_REG_19;
    volatile unsigned int DDR3_CONFIG_REG_20;
    volatile unsigned int DDR3_CONFIG_REG_21;
    volatile unsigned int DDR3_CONFIG_REG_22;
    volatile unsigned int DDR3_CONFIG_REG_23;
    volatile unsigned int DDR3_CONFIG_REG_24;
#else
    volatile unsigned int DDR3_CONFIG_REG[25];
#endif
    volatile unsigned int MARGIN1;
    volatile unsigned char RSVD16[7059];
    volatile unsigned int END_POINT;
} CSL_BootcfgRegs;
...
#define CSL_BOOTCFG_LRSTNMISTAT_CLR_NMI_STAT_2_CLR_MASK (0x00000040u)
#define CSL_BOOTCFG_LRSTNMISTAT_CLR_NMI_STAT_2_CLR_SHIFT (0x00000006u)
#define CSL_BOOTCFG_LRSTNMISTAT_CLR_NMI_STAT_2_CLR_RESETVAL (0x00000000u)

#define CSL_BOOTCFG_LRSTNMISTAT_CLR_NMI_STAT_3_CLR_MASK (0x00000080u)
#define CSL_BOOTCFG_LRSTNMISTAT_CLR_NMI_STAT_3_CLR_SHIFT (0x00000007u)
...
#define CSL_BOOTCFG_LRSTNMISTAT_NMI_STAT2_MASK (0x00000040u)
#define CSL_BOOTCFG_LRSTNMISTAT_NMI_STAT2_SHIFT (0x00000006u)
#define CSL_BOOTCFG_LRSTNMISTAT_NMI_STAT2_RESETVAL (0x00000000u)

#define CSL_BOOTCFG_LRSTNMISTAT_NMI_STAT3_MASK (0x00000080u)
#define CSL_BOOTCFG_LRSTNMISTAT_NMI_STAT3_SHIFT (0x00000007u)
...
#define CSL_BOOTCFG_STS_AIF2_B8_STS_AIF2_B8_MASK (0x1FFFFFFFu)
#define CSL_BOOTCFG_STS_AIF2_B8_STS_AIF2_B8_SHIFT (0x00000000u)
#define CSL_BOOTCFG_STS_AIF2_B8_STS_AIF2_B8_RESETVAL (0x00000000u)

#define CSL_BOOTCFG_STS_AIF2_B8_RESETVAL (0x00000000u)

/* sts_aif2_b4 */

#define CSL_BOOTCFG_STS_AIF2_B4_STS_AIF2_B4_MASK (0x00007FFFu)
#define CSL_BOOTCFG_STS_AIF2_B4_STS_AIF2_B4_SHIFT (0x00000000u)
#define CSL_BOOTCFG_STS_AIF2_B4_STS_AIF2_B4_RESETVAL (0x00000000u)

#define CSL_BOOTCFG_STS_AIF2_B4_RESETVAL (0x00000000u)
...
#define CSL_BOOTCFG_PA_PLL_CTL0_PA_PLL_CTL0_RESETVAL (0x02080140u)

#define CSL_BOOTCFG_PA_PLL_CTL0_RESETVAL (0x02080140u)
...
#define CSL_BOOTCFG_OBSCLK_CTL_PA_PLL_OBSCLK_EN_RESETVAL (0x00000001u)
...
#define CSL_BOOTCFG_AIF_SERDES_RSVD_AIF_SERDES_RSVD_MASK (0xFFFFFFFFu)
#define CSL_BOOTCFG_AIF_SERDES_RSVD_AIF_SERDES_RSVD_SHIFT (0x00000000u)
#define CSL_BOOTCFG_AIF_SERDES_RSVD_AIF_SERDES_RSVD_RESETVAL (0x00000000u)

#define CSL_BOOTCFG_AIF_SERDES_RSVD_RESETVAL (0x00000000u)
...
#define CSL_BOOTCFG_CHIP_MISC_CHIP_MISC_GEM_L2ACS_LAT_RESETVAL (0x00000004u)
