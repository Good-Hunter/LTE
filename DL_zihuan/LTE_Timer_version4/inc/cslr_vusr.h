...
typedef struct  {
    ...
    volatile unsigned int INT_PRI_VEC;
    volatile unsigned int INT_CLR;
    volatile unsigned int INT_SET;
    volatile unsigned int SW_INT;
    volatile unsigned int TX_SEL_CTL;
    volatile unsigned char RSVD0[12];
    volatile unsigned int RX_SEL_CTL;
    volatile unsigned int RX_PRIV_IDX;
    volatile unsigned int RX_PRIV_VAL;
    volatile unsigned int RX_SEG_IDX;
    volatile unsigned int RX_SEG_VAL;
    volatile unsigned int CHIP_ID_VER;
    volatile unsigned int PWR;
    volatile unsigned char RSVD1[4];
    volatile unsigned int ECC_CNTR;
    volatile unsigned char RSVD2[8];
    volatile unsigned int LINK_STS;
    volatile unsigned char RSVD3[4];
    volatile unsigned int INT_CTL_IDX;
    volatile unsigned int INT_CTL_VAL;
    volatile unsigned int INT_PTR_IDX;
    volatile unsigned int INT_PTR_VAL;
    volatile unsigned int SERDES_CTL_STS1;
    volatile unsigned int SERDES_CTL_STS2;
    volatile unsigned int SERDES_CTL_STS3;
    volatile unsigned int SERDES_CTL_STS4;
    volatile unsigned int REM_REGS[32];
} CSL_VusrRegs;
...
#define CSL_VUSR_REV_RTL_VER_RESETVAL    (0x00000002u)
...
#define CSL_VUSR_REV_REVMIN_RESETVAL     (0x00000000u)

#define CSL_VUSR_REV_RESETVAL            (0x4E901100u)
...
#define CSL_VUSR_SW_INT_SWMSTID_MASK     (0x00FF0000u)
#define CSL_VUSR_SW_INT_SWMSTID_SHIFT    (0x00000010u)
#define CSL_VUSR_SW_INT_SWMSTID_RESETVAL (0x00000000u)
