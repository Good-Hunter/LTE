...
void main()
{
	...
	/* for Synchronous transfer SRIO can either be interrupt driven or polling  */
	SrioUserConfObj.SrioModeIntrPollDriven = BSLC667X_SRIO_POLLING_MODE;
	...
	SrioUserConfObj.DoorbellCallbackFuncInfo.pCallbackFunc = NULL;
